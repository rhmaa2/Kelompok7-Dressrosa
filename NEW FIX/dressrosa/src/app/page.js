...
const manfaat = [
  {
    ...
    teks: "Buat akun sekali, dipakai untuk semua pengajuan berikutnya. Data kamu tersimpan aman lewat API EVENTRA.",
  },
  {
    judul: "Pilih alat, atur tanggal, selesai",
    teks: "Telusuri katalog lengkap dengan filter kategori, masukkan ke keranjang, lalu checkout dengan tanggal sewa yang kamu tentukan sendiri.",
  },
  {
...
export default function HomePage() {
  ...
  const hargaTermurah = barang.length
    ? Math.min(...barang.map((b) => b.hargaSewa))
    : 0;
      ...
      <main className="flex-1">
        ...
        <section className="border-b bg-white">
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-2 md:items-center md:py-24">
            ...
            <div className="relative mx-auto hidden h-[420px] w-full max-w-sm items-center justify-center rounded-2xl bg-gradient-to-br from-blue-50 to-slate-100 text-8xl shadow-inner md:flex">
              🎉
              {barang.length > 0 && (
            ...
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-slate-900">
                  Alat yang bisa kamu sewa
                </h2>
                <p className="mt-2 text-slate-600">
                  Sebagian dari katalog EVENTRA yang siap disewa hari ini.
                </p>
              </div>
              <Link href="/barang" className="text-sm font-semibold text-blue-600 hover:text-blue-700">
                Lihat semua katalog →
              </Link>
            </div>
